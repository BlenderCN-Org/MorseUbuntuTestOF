...
class Position(morse.core.actuator.Actuator):
    """ 
    This actuator position the robot to the absolute position and
    ...
    @service
    def set_position(self, x, y = 0.0, z = 0.0, roll=0.0, pitch = 0.0, yaw=0.0):
        """
