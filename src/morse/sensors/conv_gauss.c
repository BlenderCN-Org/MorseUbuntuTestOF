...
#endif
#include <math.h>
#define __PYX_HAVE__morse__sensors__conv_gauss
#define __PYX_HAVE_API__morse__sensors__conv_gauss
#include "pythread.h"
#include "string.h"
#include "stdlib.h"
#include "stdio.h"
...
static const char *__pyx_f[] = {
  "morse/sensors/conv_gauss.pyx",
  "morse/sensors/stringsource",
};
...
/* Module declarations from 'morse.sensors.conv_gauss' */
...
static __Pyx_memviewslice __pyx_f_5morse_7sensors_10conv_gauss_convGauss(__Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "morse.sensors.conv_gauss"
int __pyx_module_is_main_morse__sensors__conv_gauss = 0;

/* Implementation of 'morse.sensors.conv_gauss' */
...
static PyObject *__pyx_pf_5morse_7sensors_10conv_gauss_convGauss(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_imgmat, __Pyx_memviewslice __pyx_v_gaussMat, int __pyx_v_size); /* proto */
...
static char __pyx_k_imgmat[] = "imgmat";
...
static char __pyx_k_gaussMat[] = "gaussMat";
...
static PyObject *__pyx_n_s_gaussMat;
static PyObject *__pyx_kp_s_got_differing_extents_in_dimensi;
static PyObject *__pyx_n_s_id;
static PyObject *__pyx_n_s_imgmat;
...
/* "morse/sensors/conv_gauss.pyx":1
 * cpdef float[:] convGauss(unsigned char[:, :] imgmat, float[:, :] gaussMat, int size):             # <<<<<<<<<<<<<<
 *     cdef float[2] scal=[0,0]
 *     #cdef int[2] tt=[0,0]
 */

static PyObject *__pyx_pw_5morse_7sensors_10conv_gauss_1convGauss(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_5morse_7sensors_10conv_gauss_convGauss(__Pyx_memviewslice __pyx_v_imgmat, __Pyx_memviewslice __pyx_v_gaussMat, int __pyx_v_size, CYTHON_UNUSED int __pyx_skip_dispatch) {
  float __pyx_v_scal[2];
  int __pyx_v_p;
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_pas;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("convGauss", 0);

  /* "morse/sensors/conv_gauss.pyx":2
 * cpdef float[:] convGauss(unsigned char[:, :] imgmat, float[:, :] gaussMat, int size):
 *     cdef float[2] scal=[0,0]             # <<<<<<<<<<<<<<
 *     #cdef int[2] tt=[0,0]
 *     cdef int p, x, y, pas
 */
  __pyx_t_1[0] = 0.0;
  __pyx_t_1[1] = 0.0;
  memcpy(&(__pyx_v_scal[0]), __pyx_t_1, sizeof(__pyx_v_scal[0]) * (2));

  /* "morse/sensors/conv_gauss.pyx":5
 *     #cdef int[2] tt=[0,0]
 *     cdef int p, x, y, pas
 *     for p in range (2):             # <<<<<<<<<<<<<<
 *         pas = p * size / 2
 ...
 */
  for (__pyx_t_2 = 0; __pyx_t_2 < 2; __pyx_t_2+=1) {
    ...
    /* "morse/sensors/conv_gauss.pyx":6
 *     cdef int p, x, y, pas
 *     for p in range (2):
 *         pas = p * size / 2             # <<<<<<<<<<<<<<
 *         for x in range (pas,size+pas):
 *             for y in range (size):
 */
    __pyx_v_pas = __Pyx_div_long((__pyx_v_p * __pyx_v_size), 2);

    /* "morse/sensors/conv_gauss.pyx":7
 *     for p in range (2):
 *         pas = p * size / 2
 *         for x in range (pas,size+pas):             # <<<<<<<<<<<<<<
 *             for y in range (size):
 *                 #scal[p]=p
 */
    __pyx_t_3 = (__pyx_v_size + __pyx_v_pas);
    for (__pyx_t_4 = __pyx_v_pas; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      __pyx_v_x = __pyx_t_4;

      /* "morse/sensors/conv_gauss.pyx":8
 *         pas = p * size / 2
 *         for x in range (pas,size+pas):
 *             for y in range (size):             # <<<<<<<<<<<<<<
 *                 #scal[p]=p
 ...
 */
      ...
      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
        ...
        /* "morse/sensors/conv_gauss.pyx":13
 ...
 */
        ...
        __pyx_t_10 = -1;
        if (__pyx_t_8 < 0) {
          __pyx_t_8 += __pyx_v_imgmat.shape[0];
          if (unlikely(__pyx_t_8 < 0)) __pyx_t_10 = 0;
        } else if (unlikely(__pyx_t_8 >= __pyx_v_imgmat.shape[0])) __pyx_t_10 = 0;
        if (__pyx_t_9 < 0) {
          __pyx_t_9 += __pyx_v_imgmat.shape[1];
          if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 1;
        } else if (unlikely(__pyx_t_9 >= __pyx_v_imgmat.shape[1])) __pyx_t_10 = 1;
        if (unlikely(__pyx_t_10 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_10);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_10 = (__pyx_v_x - __pyx_v_pas);
        __pyx_t_11 = __pyx_v_y;
        __pyx_t_12 = -1;
        if (__pyx_t_10 < 0) {
          __pyx_t_10 += __pyx_v_gaussMat.shape[0];
          if (unlikely(__pyx_t_10 < 0)) __pyx_t_12 = 0;
        } else if (unlikely(__pyx_t_10 >= __pyx_v_gaussMat.shape[0])) __pyx_t_12 = 0;
        if (__pyx_t_11 < 0) {
          __pyx_t_11 += __pyx_v_gaussMat.shape[1];
          if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 1;
        } else if (unlikely(__pyx_t_11 >= __pyx_v_gaussMat.shape[1])) __pyx_t_12 = 1;
        if (unlikely(__pyx_t_12 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_12);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        (__pyx_v_scal[__pyx_t_7]) = ((__pyx_v_scal[__pyx_t_7]) + ((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_imgmat.data + __pyx_t_8 * __pyx_v_imgmat.strides[0]) ) + __pyx_t_9 * __pyx_v_imgmat.strides[1]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gaussMat.data + __pyx_t_10 * __pyx_v_gaussMat.strides[0]) ) + __pyx_t_11 * __pyx_v_gaussMat.strides[1]) )))));
      }
    }
  }

  /* "morse/sensors/conv_gauss.pyx":17
 * 
 *         #scal[p] = tt[p]/693895
 *     return scal             # <<<<<<<<<<<<<<
 */
  __pyx_t_15 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_float);
  __pyx_t_14 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)2));
  if (unlikely(!__pyx_t_15 || !__pyx_t_14 || !PyBytes_AsString(__pyx_t_15))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_15);
  __Pyx_GOTREF(__pyx_t_14);
  __pyx_t_13 = __pyx_array_new(__pyx_t_14, sizeof(float), PyBytes_AS_STRING(__pyx_t_15), (char *) "fortran", (char *) __pyx_v_scal);
  if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_13);
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
  __pyx_t_16 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(((PyObject *)__pyx_t_13));
  if (unlikely(!__pyx_t_16.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_AddTraceback("morse.sensors.conv_gauss.convGauss", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_5morse_7sensors_10conv_gauss_1convGauss(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5morse_7sensors_10conv_gauss_1convGauss(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_imgmat = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_gaussMat = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_size;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("convGauss (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_imgmat,&__pyx_n_s_gaussMat,&__pyx_n_s_size,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_imgmat)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_gaussMat)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("convGauss", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("convGauss", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "convGauss") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_imgmat = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0]); if (unlikely(!__pyx_v_imgmat.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_gaussMat = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[1]); if (unlikely(!__pyx_v_gaussMat.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_size = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_size == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("convGauss", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("morse.sensors.conv_gauss.convGauss", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5morse_7sensors_10conv_gauss_convGauss(__pyx_self, __pyx_v_imgmat, __pyx_v_gaussMat, __pyx_v_size);
...
static PyObject *__pyx_pf_5morse_7sensors_10conv_gauss_convGauss(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_imgmat, __Pyx_memviewslice __pyx_v_gaussMat, int __pyx_v_size) {
  ...
  if (unlikely(!__pyx_v_imgmat.memview)) { __Pyx_RaiseUnboundLocalError("imgmat"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_gaussMat.memview)) { __Pyx_RaiseUnboundLocalError("gaussMat"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_1 = __pyx_f_5morse_7sensors_10conv_gauss_convGauss(__pyx_v_imgmat, __pyx_v_gaussMat, __pyx_v_size, 0); if (unlikely(!__pyx_t_1.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_imgmat, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_gaussMat, 1);
 ...
 */
    ...
    if (unlikely(!Py_OptimizeFlag)) {
      ...
      if (unlikely(!__pyx_t_1)) {
        PyErr_SetNone(PyExc_AssertionError);
        {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1424; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
    }
    #endif
 ...
 */
      ...
      __pyx_v_alignment = __pyx_kp_b__14;
    }
    __pyx_L6:;
 ...
 * 
 */
    __pyx_t_3 = PyList_New(1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1431; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
 ...
 *             field += 1
 */
      __pyx_t_3 = __pyx_format_from_typeinfo(__pyx_v_field->type); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1435; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
      __pyx_t_3 = PyNumber_Add(__pyx_v_part, __pyx_kp_b__15); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1436; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_5 = __Pyx_PyBytes_FromString(__pyx_v_field->name); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1436; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = PyNumber_Add(__pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1436; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Add(__pyx_t_6, __pyx_kp_b__15); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1436; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_parts, __pyx_t_5); if (unlikely(__pyx_t_7 == -1)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1436; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    __pyx_t_5 = __Pyx_PyBytes_Join(__pyx_v_alignment, __pyx_v_parts); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1439; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = PyNumber_Add(__pyx_t_5, __pyx_kp_b__16); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1439; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (!(likely(PyBytes_CheckExact(__pyx_t_6))||((__pyx_t_6) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_t_6)->tp_name), 0))) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1439; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         else:
 */
      __pyx_t_6 = PyList_New(0); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1443; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_8 = __pyx_v_type->ndim;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_v_i = __pyx_t_9;
        __pyx_t_5 = __Pyx_PyInt_FromSize_t((__pyx_v_type->arraysize[__pyx_v_i])); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1443; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_3 = PyTuple_New(1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1443; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_t_5);
        __Pyx_GIVEREF(__pyx_t_5);
        __pyx_t_5 = 0;
        __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)(&PyUnicode_Type))), __pyx_t_3, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1443; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        if (unlikely(__Pyx_ListComp_Append(__pyx_t_6, (PyObject*)__pyx_t_5))) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1443; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      }
 ...
 *             result = fmt.string
 */
      __pyx_t_6 = PyUnicode_Join(__pyx_kp_u__17, __pyx_v_extents); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1444; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_5 = PyUnicode_Format(__pyx_kp_u_s, __pyx_t_6); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1444; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyUnicode_AsASCIIString(((PyObject*)__pyx_t_5)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1444; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = __Pyx_PyObject_FromString(__pyx_v_fmt.string); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1444; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_3 = PyNumber_Add(__pyx_t_6, __pyx_t_5); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1444; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      if (!(likely(PyBytes_CheckExact(__pyx_t_3))||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_t_3)->tp_name), 0))) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1444; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_v_result = ((PyObject*)__pyx_t_3);
      __pyx_t_3 = 0;
      goto __pyx_L9;
    }
 ...
 *     return result
 */
      __pyx_t_3 = __Pyx_PyObject_FromString(__pyx_v_fmt.string); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1446; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_v_result = ((PyObject*)__pyx_t_3);
      __pyx_t_3 = 0;
    }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "morse.sensors.conv_gauss.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "morse.sensors.conv_gauss.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "morse.sensors.conv_gauss.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "morse.sensors.conv_gauss._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"convGauss", (PyCFunction)__pyx_pw_5morse_7sensors_10conv_gauss_1convGauss, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_gaussMat, __pyx_k_gaussMat, sizeof(__pyx_k_gaussMat), 0, 0, 1, 1},
  {&__pyx_kp_s_got_differing_extents_in_dimensi, __pyx_k_got_differing_extents_in_dimensi, sizeof(__pyx_k_got_differing_extents_in_dimensi), 0, 0, 1, 0},
  {&__pyx_n_s_id, __pyx_k_id, sizeof(__pyx_k_id), 0, 0, 1, 1},
  {&__pyx_n_s_imgmat, __pyx_k_imgmat, sizeof(__pyx_k_imgmat), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initconv_gauss(void); /*proto*/
PyMODINIT_FUNC initconv_gauss(void)
#else
PyMODINIT_FUNC PyInit_conv_gauss(void); /*proto*/
PyMODINIT_FUNC PyInit_conv_gauss(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_conv_gauss(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("conv_gauss", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_morse__sensors__conv_gauss) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "morse.sensors.conv_gauss")) {
      if (unlikely(PyDict_SetItemString(modules, "morse.sensors.conv_gauss", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init morse.sensors.conv_gauss", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init morse.sensors.conv_gauss");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
...
static int __Pyx_main(int argc, wchar_t **argv) {
    ...
    {
      PyObject* m = NULL;
      __pyx_module_is_main_morse__sensors__conv_gauss = 1;
      #if PY_MAJOR_VERSION < 3
          initconv_gauss();
      #else
          m = PyInit_conv_gauss();
